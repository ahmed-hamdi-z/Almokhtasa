...
const AboutHero: React.FC= () => {
    ...
    return (
        <div className=" w-full ">
            <div className=" w-[150%] ml-[-20vh] ltr:md:ml-[-20%] rtl:mr-[-20%] md:h-screen relative bg-center bg-cover md:top-[-28vh] top-[-5vh] bg-about flex items-center justify-center mb-16">
